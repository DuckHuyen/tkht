...
namespace BTL
{
    public partial class qlcvden : Form
    {
        public qlcvden()
        {
            InitializeComponent();
        ...
        private void qlcvden_Load(object sender, EventArgs e)
        {
            LoadDataIntoComboBox(comboBox3, "donvi", "tendonvi");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string connectionString = "Host=localhost;Database=x;Username=postgres;Password=Duckhuyen1.;";
            string query = "SELECT * FROM congvanden WHERE 1 = 1";
            ...
            if (comboBox3.Text.Trim() != "") query += " AND dvgui LIKE @dvgui";
            DataTable dataTable = new DataTable();
            using (NpgsqlConnection connection = new NpgsqlConnection(connectionString))
            {
                connection.Open();
                ...
                if (comboBox3.Text.Trim() != "") command.Parameters.AddWithValue("@dvgui", comboBox3.Text.Trim() );
                listView1.Items.Clear();
